...
module mult_accum (
	...
	localparam OUTPUT_DATA_WIDTH = (DATA_WIDTH * 2) + 1;
...
`endif
	tri0	  accum_sload;
	tri1	  clock0;
	tri0	[DATA_WIDTH-1:0]  dataa;
	tri0	[DATA_WIDTH-1:0]  datab;
`ifndef ALTERA_RESERVED_QIS
// synopsys translate_on
`endif
	...
	defparam
		...
		altmult_accum_component.extra_multiplier_latency = PIPE_WIDTH,
		...
		altmult_accum_component.width_a = DATA_WIDTH,
		altmult_accum_component.width_b = DATA_WIDTH,
		altmult_accum_component.width_result = OUTPUT_DATA_WIDTH;
...
// Retrieval info: PRIVATE: EXTRA_MULTIPLIER_LATENCY NUMERIC "2"
...
// Retrieval info: PRIVATE: MULT_LATENCY NUMERIC "1"
...
// Retrieval info: PRIVATE: RNFORMAT STRING "25"
// Retrieval info: PRIVATE: RQFORMAT STRING "Q1.30"
// Retrieval info: PRIVATE: RTS_WIDTH STRING "25"
...
// Retrieval info: CONSTANT: EXTRA_MULTIPLIER_LATENCY NUMERIC "2"
...
// Retrieval info: USED_PORT: dataa 0 0 12 0 INPUT GND "dataa[11..0]"
// Retrieval info: USED_PORT: datab 0 0 12 0 INPUT GND "datab[11..0]"
// Retrieval info: USED_PORT: result 0 0 25 0 OUTPUT GND "result[24..0]"
