...
parser.add_argument('--int_bits', type=int, nargs=1, default=12, help='integer bits')
parser.add_argument('--frac_bits', type=int, nargs=1, default=12, help='fractional bits')
...
parser.add_argument('--filenames', metavar='F', type=str, nargs='+', default=["fc_parameters_1", "fc_parameters_2"], help='file names to be converted')

args = parser.parse_args()
int_bits = int(args.int_bits)
